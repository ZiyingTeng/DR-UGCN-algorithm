...
class NonlinearDiffusionAwareModel(nn.Module):
    def __init__(self, in_channels, hidden_channels=64, out_channels=1, num_raw_features=6, num_heads=4):
        ...
        self.feature_norm = nn.BatchNorm1d(in_channels, affine=False)# 只标准化，不学习缩放参数
        ...
        # 记忆机制
        self.memory_bank = nn.Parameter(torch.randn(10, hidden_channels) * 0.1)
    ...
    def _apply_memory_enhancement(self, embeddings):
        ...
        # 温和的残差连接
        return embeddings + 0.1 * memory_output
